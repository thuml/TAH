...
code_and_label = {}
code_and_label['dataset'] = 'an/val'
code_and_label['codelength'] = "32"
code_and_label['path'] = code_and_label['dataset'] + "/code" + code_and_label['codelength']
code_and_label['prefix'] = "code_" + code_and_label['codelength'] + "_new"
...
precision, recall = precision_recall_hamming2(code_and_label)

sio.savemat(code_and_label['dataset'] + "_" + code_and_label["prefix"] + "mat_file.mat", {"precision": precision, "recall": recall})
